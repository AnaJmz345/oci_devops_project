...
- Name: auth.spec.ts >> @auth @mocked-api authentication >> shows unauthenticated landing with seven visible locator styles
- Location: src\test\e2e\specs\auth.spec.ts:26:7
